...
void analyze_hcal_wave_event(const char *fname = "hot_tower_waveform_cemc_02_21518.root", const char *outfname = "test_waveform.root") {	

    int test_event = 6;
    int test_events[] = {8,14,18,24,45,48,65,91,91,93};
    ...
    // 9728-9791
    int channel_number[] = {247,1299,288,136,223,52,142,24,1252,1326};
    ...
    for (int i = 0; i < 10; i++) {
        ...
        h_wave_test[i]->SetTitle(TString::Format("OHCal channel %d run 21520 event %d",channel_number[i],test_events[i]));
